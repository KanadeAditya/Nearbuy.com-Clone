...
function createCards(item){
    ...
    return `<div class="cards" data-cards="card${ID}">
                ...
                <div class="card-btn">
                    <button class="add-buttons" data-id="${ID}" data-name="${name}" data-type="${type}" data-loc="${loc}" data-price="${price}">Add</button>
                </div>
            </div>`
}